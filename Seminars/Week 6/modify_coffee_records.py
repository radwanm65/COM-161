...
def main():
    ...
    new_roast = input('Enter the new Roast (Light, Medium or Dark): ')
    new_type = input('Enter the new Type (Ground or Beans): ')
    ...
    while descr != '':
        ...
        roast= coffee_file.readline()
        type= coffee_file.readline()
